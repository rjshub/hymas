<template>
    <div class="card-list">
        <card v-for="(item,index) in cardData"
...
export default {
  ...
  data() {
    return {
      isSpreadLevelFirst: false, //是否全部展开 level -1
      cardData: []
    };
  },
