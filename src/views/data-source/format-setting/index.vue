  ...
  <div class="formatSetting-container">
    ...
    <main>
      <div class="tools">
        <hy-box>
          <el-button
            :disabled="format_create"
            type="primary"
            size="mini"
            icon="el-icon-plus"
            @click="handle_add_format"
          >Create data source format</el-button>
        </hy-box>
...
export default {
  ...
  computed: {
    ...mapState("dataSource/formatSetting", ["format_create"])
  },
  methods: {
