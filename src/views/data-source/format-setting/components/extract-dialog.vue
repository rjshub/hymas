          ...
          <el-col :span="4">
            <el-form-item prop="extract">
              <el-select v-model="form.extract" placeholder="Field">
                <el-option v-for="item in extract_list" :key="item" :label="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="2">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        from_extract: [{ required: true, message: "", trigger: "blur" }]
      },
      form: {
        field_type: "Year",
        label: "",
      ...
      extract_list: ["Year", "Month", "Date", "Time"]
    };
  },
  computed: {
