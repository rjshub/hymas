        ...
        <el-dialog
            ...
            <el-form :rules="rules" :model="form" ref="connectForm" class="demo-form-inline" size='mini'>
                <el-row :gutter="10" style="width:100%;">
                    ...
                    <el-col :span="4">
                        <el-form-item style="margin-right: 0" prop="connect_table_by" :title="form.connect_table_by">
                    ...
                    <el-col :span="4" style="display:flex;align-items:center">
                        <el-form-item style="margin-right: 0;flex:1" prop="connect_field_by" :title="form.connect_field_by">
                    ...
                    <el-col :span="4" style="display:flex;align-items:center">
                        <el-form-item style="margin-right: 0;flex:1" prop="connect_target_field" :title="form.connect_field_by">
