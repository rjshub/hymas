<template>
    <div class="format-list">
      <div class="collapse-item" v-for="(item, index) in format_list" :key="index">
        <header>
          ...
          <div class="format-handle">
            <span class="iconfont" :class="active === index? 'mas-up2':'mas-down2'" @click="change_active(index)"></span>
            ...
            <div class=list>
              <div class="field-item" v-for="(field, index) in item.list" :key="index">
                <span :class="field.type === 'normal'? 'normal_field':'special_field'">
                  {{field.location}}
                  <i :class="get_special_field_icon(field.type)" :title="field.formula"></i>
                </span>
      ...
      <div class="list-empty" v-show="format_list.length === 0">
        Pleace click the button to  create your first data source format!
      </div>
    </div>
</template>
